...
def build_route_kml():
    ...
    route = kml.newlinestring(name="Route", description="Bridgestone World Solar Challenge Route",
                    coords=coords)
    ...
    for _,stop in route_data[route_data["name"].isnull() is False].iterrows():
